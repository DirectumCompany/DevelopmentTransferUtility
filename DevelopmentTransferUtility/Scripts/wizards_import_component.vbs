' Скрипт импорта МД из папки в БД с фильтрацией по компонентам.
...
commandLine = Replace(commandLine, "{8}", importFolders)
commandLine = Replace(commandLine, "{9}", packageType)
